...
sub initPlugin {
    ...
    Foswiki::Func::registerTagHandler( 'REGISTERMACRO',
...
sub registerMacroHandler {
    ...
    if (
        defined( $Foswiki::functionTags{$theName} ) ||    # Foswiki < 1.1
      ...
      )
    {
        ...
        return
          "<span class='foswikiAlert'>ERROR: can't redefine $theName</span>";
    }
    ...
    if ($theFormat) {    # format mode
        ...
        Foswiki::Func::registerTagHandler(
            ...
            sub {
                ...
                # merge
                if ( $theDefaultParam
                    && !defined( $innerParams->{$theDefaultParam} ) )
                {
        ...
        Foswiki::Func::registerTagHandler(
            ...
            sub {
                ...
                $innerParams =
                  bless( { %$params, %$innerParams }, 'Foswiki::Attrs' );
